...
if (temperature >= 80 && rain === true) {
  ...
  console.log("one should wear loose fitting clothing or anything that is light-weight");
} else if (temperature > 60 && temperature < 80 && rain === false) {
  console.log("one should wear casual clothing and keep a sweater on hand");
} else if (temperature >= 60 && rain === false) {
  console.log("one should wear a coat and boots to keep their feet warm");
}
  ////////// PROBLEM 5 //////////
